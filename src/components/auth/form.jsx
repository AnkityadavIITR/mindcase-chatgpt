  ...
  return (
    <div className="w-[350px] flex flex-col mt-10">
      {!showVerifyModal ? (
          ...
          <div className="flex justify-center  flex-col gap-y-5 w-[300px] mx-auto">
            <div className="relative">
              <div className="flex relative">
                ...
                {showPasswordInput && (
                  <Button
                    className="absolute right-1 bg-white text-customGreen hover:bg-white top-1 my-auto rounded-none"
                    onClick={() => {
            ...
            {showEmailError && (
              <div>
                <h1 className="text-red-500 text-[14px]">Invalid email</h1>
              </div>
            )}
            ...
            <Button
              className={
                loading
                  ? "bg-customGreen rounded-md text-[16px] py-3 h-auto hover:bg-customGreen opacity-40"
                  : "bg-customGreen rounded-md text-[16px] py-3 h-auto hover:bg-customGreen hover:opacity-70"
              }
              disabled={loading}
              onClick={() => {
        ...
        <Card className="bg-white text-black border-2">
          <CardHeader>
